...
export const WordCard = (props: Props) => {
  ...
  const handleZoneDrop = (evt: any) => {
    ...
    UpdateFamiliarity(props.originalWord || '', evt.target.id);
  };
  ...
  return (
    <>
      <div className="flex items-stretch">
        <div
          id="bad"
          onDragLeave={handleDragAway}
          onDragEnter={handleDragOver}
          className="w-[50vw] h-screen border-dashed border-red-500 border-8 flex justify-start"
        ...
        <div
          ...
          onDragLeave={handleDragAway}
          onDragEnter={handleDragOver}
          className="w-[50vw] h-screen border-dashed border-blue-500 border-8 flex justify-end"
          onDrop={handleZoneDrop}
          onDragOver={handleZoneDragOver}
        >
